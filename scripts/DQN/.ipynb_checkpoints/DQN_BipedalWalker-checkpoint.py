...
class AGENT:
    def __init__(self, nx, ny, lr, gamma, s_link):
        ...
        #wrappers.Monitor(self.env, monitor_dir, video_callable=True, force=True)     
    ...
    def MODEL(self):                     
        # Build Network
        model = Sequential()
        model.add(Dense(2500, input_dim=self.nx, activation='relu'))
...
if __name__ == '__main__':
    ...
    monitor_dir = mkdir(videos_dir, 'BipedalWalker-v3')
